                ...
                <tbody>
                    {produtos.map((value, index) => (
                        <tr key={value.codigo}>
                            ...
                            <td><div className="icontrash" onClick={() => handlerFavoritoClick(value.codigo)} title="tornar favorito.">{value.favorito?<StarFillIcon size={16}/>:<StarIcon size={16}/>}</div></td>
                            <td>{value.produto}</td>
